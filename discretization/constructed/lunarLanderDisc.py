def state2region(s):
    ...
    d0 = min(3, max(-3, int(s[0] / 0.05)))   # 7 values
    d1 = min(5, max(-1, int(s[1] / 0.1)))    # 7 values
    d2 = min(3, max(-3, int(s[2] / 0.1)))    # 7 values
    d3 = min(3, max(-3, int(s[3] / 0.1)))    # 7 values
    d4 = min(3, max(-3, int(s[4] / 0.1)))    # 7 values
...
def region2centre(index):
    ...
    return (
        ...
        (d1 + 0.5) * 0.1,    # y position
        (d2 + 0.5) * 0.1,    # x velocity
        (d3 + 0.5) * 0.1,    # y velocity
        (d4 + 0.5) * 0.1,    # angle
