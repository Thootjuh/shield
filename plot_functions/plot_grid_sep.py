...
def plot_all_methods(data, env_name, ax):
    ...
    for method in sorted_methods:
        ...
        if method == 'shielded_baseline':
            ...
            # ax.errorbar(x, y, yerr=yerr, label=method, linestyle='-', color=color, capsize=3)
    ...
    ax.set_ylabel('Avg Method Performance', fontsize="15")
    ax.set_title(f'{env_name}', fontsize="20")
    ax.grid(True)
...
def main(parent_directory):
    ...
    plt.subplots_adjust(bottom=0.2)  # Make space at the bottom for the legend
