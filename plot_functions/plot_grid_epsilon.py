...
def plot_all_methods(ax, data, title, color):
    ...
    for method in sorted_methods:
        ...
        line, = ax.plot(method_data['epsilon_baseline'], method_data['method_perf'],
...
plot_multiple_directories(parent_directory, "combined_results_epsilonBig.png")
